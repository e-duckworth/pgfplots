...
"mark options" could be combined with "mark = *" in a single
"\addplot" to give us the same graph.)
...
\footnote{This is either a bug in \code{pgfplots}, or maybe just an
  ...
  allows the path to extend past the 9th point and towards the 10th
  point.  We can verify this behavior by adding \code{enlargelimits =
